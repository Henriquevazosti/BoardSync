...
const Column = ({ column, cards, totalCards, allCards, allLabels, allUsers, onAddCard, onMoveCard, onEditCard, onBlockCard, onManageLabels, onViewActivityLog, onViewComments }) => {
